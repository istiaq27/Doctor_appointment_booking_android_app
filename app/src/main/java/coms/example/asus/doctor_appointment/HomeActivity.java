                       ...
                       holder.txtDoctorSpeciality.setText(model.getSpeciality());
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                Intent intent = new Intent(HomeActivity.this, DoctorDetailsActivity.class);
...
//        }
    ...
    public boolean onNavigationItemSelected(MenuItem item)
    {
        ...
        else if (id == R.id.nav_appoints_cart)
        {
        ...
        {
            Intent intent = new Intent(HomeActivity.this, SearchDoctorsActivity.class);
            startActivity(intent);
