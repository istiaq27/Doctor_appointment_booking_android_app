...
public class CartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtTotalAmount = (TextView) findViewById(R.id.total_fees);

        NextProcessBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view)
            {
                Intent intent = new Intent(CartActivity.this, ConfirmFinalBookingActivity.class);
                    ...
                    public void onClick(View view)
                    {
                        ...
                        builder.setItems(options, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i)
                            {
                                if(i==0)
                                {
                                    Intent intent = new Intent(CartActivity.this, DoctorDetailsActivity.class);
                                ...
                                if (i == 1)
                                {
                                    cartListRef.child("User View").child((Prevalent.currentOnlineUser).getPhone())
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                {
                                                    Toast.makeText(CartActivity.this, "Doctor Removed Successfully", Toast.LENGTH_SHORT).show();
